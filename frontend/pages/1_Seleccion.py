...
st.set_page_config(page_title="Selección - Optimizador", page_icon="📊", layout="wide")
st.title("📊 Selección de Portafolio")
...
# --- Method ---
st.subheader("🧠 Método de Optimización")
method = st.radio(
    ...
    if len(selected_tickers) < 2:
        ...
        with st.spinner("Descargando datos y optimizando... Esto puede tomar unos segundos."):
            try:
                ...
                st.success("✅ Optimización completada. Ve a la página **Resultados** para ver el análisis.")
                st.balloons()
